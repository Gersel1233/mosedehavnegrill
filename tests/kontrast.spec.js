...
test.describe('Forsiden kan læses', () => {
  ...
  const PAA_FOTO = [
    ...
    /* Nyhederne stod en overgang på isfilmen med to målinger her
       mod filmens værst tænkelige billede. Filmen er hjemme i
       isafsnittet igen; kortene er lyse på solid marineblå og
       dækkes af SOLIDE-listen ovenfor som alt andet. */
  ];
